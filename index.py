...
class Window_1:
    def __init__(self, master):
        ...
        self.Lbl_Title = Label(self.Frame, text = 'Login Menu', font = ('arial',55,'bold'), bg = 'lightblue', fg = 'Black')
    ...
    def Exit(self):
        self.Exit = tkinter.messagebox.askokcancel("School Management System", "Confirm if you want to Exit")
        if self.Exit > 0:
            self.master.destroy()
            return

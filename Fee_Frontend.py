...
class Fee():
    def __init__(self, master):
        ...
        self.admsn_label = Label(Frame_1, text='Roll No : ', font=(
            'arial', 14, 'bold'), bg='lightblue')
        ...
        self.branch_label = Label(Frame_1, text='Dept : ', font=(
            'arial', 14, 'bold'), bg='lightblue')
        ...
        # =================Entries=========================
        self.var_1 = DoubleVar(Frame_1, value='18000')
        ...
        self.branch_entry = ttk.Combobox(Frame_1, values=(' ', 'SW', 'TL', 'CS', 'ES', 'CE', 'PG', 'IN', 'MT'),
